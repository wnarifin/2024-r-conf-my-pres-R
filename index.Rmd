...
coef_ci = function(tidy_or, estimate_number = 2, #<<
                   digits = 1) { #<<
  paste0(tidy_or$estimate[estimate_number]|>round(digits),
    " (95% CI: ", 
    tidy_or$conf.low[estimate_number]|>round(digits),
    ", ", 
    tidy_or$conf.high[estimate_number]|>round(digits), ")")
}
# analysis part
...
<img src="img/graphic card with powerful GPU, fire, smoke, moving fans, white background.png" height="250px" alt="Image generated with Copilot"></br>
